<div class="d-flex align-items-center">
    ...
    <div class="dropdown-menu dropdown-menu-end m-0">
        ...
        @can($routeInitialize.'-edit')
            <button
                data-toggle="tooltip" data-placement="top" title="Fields of {{ $model->menu }}"
                data-edit-url="{{ route('menu_fields.edit', $model->id) }}"
                data-url="{{ route('menu_fields.update', $model->id) }}"
