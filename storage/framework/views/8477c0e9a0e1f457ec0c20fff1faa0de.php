                        ...
                        <div class="card-body">
                            <form id="company-settings" action="<?php echo e(route('settings.update', getSetting('id', 1))); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" 
                                            value="<?php echo e(getSetting('name', null)); ?>" 
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control phoneNumber" type="text" 
                                            name="settings[phone_number]" value="<?php echo e(getSetting('phone_number', null)); ?>" id="phone_number" 
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="email" name="settings[support_email]" value="<?php echo e(getSetting('support_email', null)); ?>" id="support_email" placeholder="Enter support email" />
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="email" name="settings[sale_email]" value="<?php echo e(getSetting('sale_email', null)); ?>" id="sale_email" placeholder="Enter sale email" />
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10 d-flex gap-2">
                                        <select name="settings[day_range]" class="form-select w-auto">
                                            <option value="Mon-Fri" <?php echo e(getSetting('day_range', null)=='Mon-Fri'?'selected':''); ?>>Mon-Fri</option>
                                            <option value="Sat-Sun" <?php echo e(getSetting('day_range', null)=='Sat-Sun'?'selected':''); ?>>Sat-Sun</option>
                                        </select>
                                        ...
                                        <select name="settings[timezone]" class="form-select w-auto">
                                            <option value="CDT" <?php echo e(getSetting('timezone', null)=='CDT'?'selected':''); ?>>CDT</option>
                                            <option value="EST" <?php echo e(getSetting('timezone', null)=='EST'?'selected':''); ?>>EST</option>
                                            <option value="PST" <?php echo e(getSetting('timezone', null)=='PST'?'selected':''); ?>>PST</option>
                                            <option value="UTC" <?php echo e(getSetting('timezone', null)=='UTC'?'selected':''); ?>>UTC</option>
                                        </select>
                                    </div>
                                </div>                                
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="settings[website_url]" id="website_url" class="form-control" placeholder="Enter website url"><?php echo e(getSetting('website_url', null)); ?></textarea>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="settings[location_map_url]" id="location_map_url" class="form-control" placeholder="Enter website url"><?php echo e(getSetting('location_map_url', null)); ?></textarea>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <select name="settings[country]" id="country" class="form-select" data-url="<?php echo e(route('get-states')); ?>">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <select name="settings[state]" id="state" class="form-select" data-url="<?php echo e(route('get-cities')); ?>">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="settings[zip_code]" value="<?php echo e(getSetting('zip_code', null)); ?>" id="zip_code" placeholder="Enter zip code"/>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" name="settings[area]" value="<?php echo e(getSetting('area', null)); ?>" id="area" placeholder="Enter area"/>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="settings[address]" id="address" class="form-control" placeholder="Enter address"><?php echo e(getSetting('address', null)); ?></textarea>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="settings[facebook_link]" id="" class="form-control" placeholder="Enter facebook link here..."><?php echo e(getSetting('facebook_link', null)); ?></textarea>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="settings[instagram_link]" id="instagram_link" class="form-control" placeholder="Enter instagram link here..."><?php echo e(getSetting('instagram_link', null)); ?></textarea>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="settings[linked_in_link]" id="linked_in_link" class="form-control" placeholder="Enter linkedIn link here..."><?php echo e(getSetting('linked_in_link', null)); ?></textarea>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="settings[twitter_link]" class="form-control" placeholder="Enter twitter link here..."><?php echo e(getSetting('twitter_link', null)); ?></textarea>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
