<div class="d-flex align-items-center">
    ...
    <div class="dropdown-menu dropdown-menu-end m-0">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check($routeInitialize.'-edit')): ?>
            <a href="<?php echo e(route($routeInitialize.'.edit', $model->id)); ?>"
                class="dropdown-item"
                data-toggle="tooltip"
                data-placement="top"
                title="Edit <?php echo e($singularLabel); ?>">
                Edit
            </a>
        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\dynamic-admin-panel\resources\views/admin/roles/action.blade.php ENDPATH**/ ?>