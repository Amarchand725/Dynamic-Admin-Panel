...
<input type="hidden" id="page_url" value="<?php echo e(route(Route::currentRouteName())); ?>">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-end align-item-center">
                                <div class="dt-buttons btn-group flex-wrap">
                                    <button data-toggle="tooltip" data-placement="top" title="Refresh " type="button" class="btn btn-secondary add-new btn-primary me-3" id="refresh-btn" data-url="<?php echo e(route('logs.index')); ?>">
                                        <span>
