                ...
                <?php if($name=='role'): ?>
                    <select id="<?php echo e($name); ?>" name="<?php echo e($name); ?>" class="form-control">
                        ...
                        <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($role->name); ?>" <?php echo e($model->getRoleNames()->first()==$role->name?'selected':''); ?>><?php echo e($role->name); ?></option>                            
...
</script><?php /**PATH C:\xampp\htdocs\dynamic-admin-panel\resources\views/admin/users/edit_content.blade.php ENDPATH**/ ?>